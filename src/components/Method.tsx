    ...
    <section className="py-20 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="space-y-6 mb-12">
          {avoids.map((avoid, i) => (
            <div key={i} className="flex items-start gap-4">
              ...
              <p className="text-lg md:text-xl">{avoid}</p>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-black px-12 py-7 rounded-full text-lg">
            APPLY NOW
          </Button>
        </div>
      </div>
